# Contributing to Etherna Asp Common Resources

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to Etherna Asp Common Resources and its packages. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
This section guides you through submitting a bug report for Etherna Asp Common Resources. Following these guidelines helps maintainers and the community understand your report :pencil:, reproduce the behavior :computer: :computer:, and find related reports :mag_right:.
...
* **Perform a [issue search](https://etherna.atlassian.net/browse/ACR)** to see if the problem has already been reported. If it has **and the issue is still open**, add a comment to the existing issue instead of opening a new one.
...
* **Perform a [issue search](https://etherna.atlassian.net/browse/ACR)** to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
