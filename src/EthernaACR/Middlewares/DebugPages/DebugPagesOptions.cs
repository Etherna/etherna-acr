...
namespace Etherna.ACR.Middlewares.DebugPages
{
    ...
    {
        public string ConfigurationPagePath { get; set; } = "/debug/config";
        public string ConfigurationPageTitle { get; set; } = "Configuration";
        public string RequestPagePath { get; set; } = "/debug/request";
        public string RequestPageTitle { get; set; } = "Request";
    }
}
